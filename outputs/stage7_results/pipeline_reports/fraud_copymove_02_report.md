# ScholarGuard Integrity Report — fraud_copymove_02.pdf

- **Generated:** 2026-07-08T23:36:07
- **Status:** completed
- **Overall paper risk:** **MODERATE** (score 25.75/100, 2 figure(s))
...
## Figure 1 — risk MODERATE (score 30.29/100)
> Microscopy field of treated cells (n = 6).

| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 20.29/35.0 | duplicated regions within figure (conf 0.5797) |
