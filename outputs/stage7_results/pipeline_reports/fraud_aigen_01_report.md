# ScholarGuard Integrity Report — fraud_aigen_01.pdf

- **Generated:** 2026-07-08T23:36:14
- **Status:** completed
- **Overall paper risk:** **MODERATE** (score 28.54/100, 2 figure(s))
...
## Figure 1 — risk MODERATE (score 33.58/100)
> Representative micrograph (n = 6).

| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 23.58/35.0 | duplicated regions within figure (conf 0.6736) |
