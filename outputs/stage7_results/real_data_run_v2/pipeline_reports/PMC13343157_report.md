...
- **Generated:** 2026-07-11T23:35:48
- **Status:** completed
- **Overall paper risk:** **HIGH** (score 50.62/100, 7 figure(s))
...
## Figure 1 — risk HIGH (score 50.8/100)
...
|---|---|---:|---|
| copy_move | ok | 23.8/35.0 | duplicated regions within figure (conf 0.6801) |
...
## Figure 2 — risk HIGH (score 56.86/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 29.86/35.0 | duplicated regions within figure (conf 0.8532) |
| cross_figure | ok | 27.0/30.0 | 1 reused region(s) from another figure |
| ai_generation | ok | 0.0/20.0 | AI-generation verdict: likely_real (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |

## Figure 3 — risk MODERATE (score 28.16/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 28.16/35.0 | duplicated regions within figure (conf 0.8046) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 0.0/20.0 | AI-generation verdict: likely_real (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |

## Figure 4 — risk MODERATE (score 28.77/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 28.77/35.0 | duplicated regions within figure (conf 0.8221) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 0.0/20.0 | AI-generation verdict: likely_real (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |

## Figure 5 — risk MODERATE (score 27.75/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 27.75/35.0 | duplicated regions within figure (conf 0.7929) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 0.0/20.0 | AI-generation verdict: likely_real (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |

## Figure 6 — risk MODERATE (score 33.13/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 33.13/35.0 | duplicated regions within figure (conf 0.9465) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 0.0/20.0 | AI-generation verdict: likely_real (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |

## Figure 7 — risk MODERATE (score 27.05/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 27.05/35.0 | duplicated regions within figure (conf 0.773) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 0.0/20.0 | AI-generation verdict: likely_real (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |
