...
- **Generated:** 2026-07-10T09:06:35
- **Status:** completed
- **Overall paper risk:** **HIGH** (score 55.0/100, 11 figure(s))
...
## Figure 1 — risk MODERATE (score 32.79/100)
...
|---|---|---:|---|
| copy_move | ok | 22.79/35.0 | duplicated regions within figure (conf 0.651) |
...
## Figure 2 — risk HIGH (score 71.02/100)
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 35.0/35.0 | duplicated regions within figure (conf 1.0009) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 10.0/20.0 | AI-generation verdict: suspicious (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |
...
| Detector | Status | Points | Finding |
|---|---|---:|---|
| copy_move | ok | 35.0/35.0 | duplicated regions within figure (conf 1.0262) |
| cross_figure | ok | 0.0/30.0 | only low-confidence visual-similarity leads |
| ai_generation | ok | 10.0/20.0 | AI-generation verdict: suspicious (forensics-only, no classifier) |
| claim_consistency | skipped | 0.0/15.0 | claim-consistency skipped |
